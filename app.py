...
class GTUReport(FPDF):
    def header(self):
        ...
        self.rect(4.5, 4.5, 201, 288)
        self.set_line_width(1.2) 
        self.rect(5.5, 5.5, 199, 286)
        self.set_line_width(0.2)
        self.rect(6.8, 6.8, 196.4, 283.4)
        
        self.set_y(15)
        self.set_font("times", "", 12)
        self.cell(0, 6, "Sardar Vallabhbhai Education Society's", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
        self.set_font("times", "B", 18)
        self.cell(0, 10, "R. N. G. PATEL INSTITUTE OF TECHNOLOGY", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
        self.set_font("times", "", 11)
        self.cell(0, 5, "ISROLI, BARDOLI - 394620", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
        
        self.ln(5)
        self.set_font("times", "B", 14)
        self.cell(0, 7, "COMPUTER SCIENCE AND ENGINEERING DEPARTMENT", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
        self.set_font("times", "B", 16)
        self.cell(0, 10, "PRACTICAL / TERM-WORK REPORT", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='C')
...
def generate_pdf_bytes(data):
    ...
    pdf.line(title_start_x, 126, 195, 126)
    pdf.line(20, 136, 195, 136)            
    pdf.line(20, 146, 195, 146)            

    # --- BLOCK 2: DATA OVERLAY ---
    pdf.set_font("times", "", 12) 
    pdf.set_y(58)
    pdf.set_x(171)
...
# Use a form structure to clean up processing
...
if submitted:
    if not work_no or not title:
        ...
        # Generate the PDF file compilation stream dynamically
